...
- Cree un proyecto de Angular con ng: `ng new ballestlaneapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Crear archivo de proyecto (`ballestlaneapp.client.esproj`).
